...
<body>
	...
	<c:if
		test="${sessionScope.logado eq false or sessionScope.logado eq null}">
		<c:redirect url="/" />
	</c:if>

	<div class="conteiner">
		<div class="panel panel-default" id="faltas">
			<div class="panel-heading">
				<h3>Faltas</h3>
			</div>
			<div class="panel-body">
				<form action="insere" method="post"></form>
			</div>
		</div>
	</div>
